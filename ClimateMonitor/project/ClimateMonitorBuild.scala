...
object ClimateMonitorBuild extends Build {
  import Settings._
  ...
  lazy val clients = Project(
    id = "clients",
    base = file("./ClimateMonitor-clients"),
    dependencies = Seq(core),
  ...
  lazy val examples = Project(
    id = "examples",
    base = file("./ClimateMonitor-examples"),
