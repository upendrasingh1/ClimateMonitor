...
import com.acme.ClimateMonitor.cluster.ClusterAwareNodeGuardian
...
private[ClimateMonitor] class AutomatedApiActor extends Actor with ActorLogging with ClientHelper {
